...
Currently building production real-time decisioning systems and machine learning–driven pricing infrastructure in the sports domain. Recently architected and launched NHL microbetting markets for Caesars and Hard Rock, enabling real-time in-play betting products. Currently leading soccer markets ahead of the upcoming World Cup cycle, focusing on scalability and reliability under high event load.
...
This profile contains selected projects, experiments, and learning work. Production contributions are primarily in private repositories.
